<section id="section-services" class="section-services bg-LightGray xl:pt-20 xl:pb-24">
  <div class="theme-container">
    <div class="theme-grid">
      ...
      <div class="col-span-2 md:col-span-4 xl:col-span-5 col-start-1 md:col-start-1 xl:col-start-6 xl:pt-14">
        <?php

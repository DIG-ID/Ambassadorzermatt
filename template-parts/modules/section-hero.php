...
<?php endif; ?>
<div id="booking-bar" class="booking-bar hidden xl:block fixed theme-container theme-grid bottom-11 left-1/2 -translate-x-1/2 w-full z-30 mx-auto rounded-full bg-[rgba(118,106,102,0.35)] bg-gradient-to-b from-white/10 to-black/10 backdrop-blur-xl backdrop-saturate-150">
    <div class="col-span-12 flex justify-center md:justify-around items-center pt-7 pb-8">
      ...
      <a href="<?php the_field( 'general_table_reservation_url','option' ); ?>" target="_blank" class="btn btn-sticky-bar-light max-w-56"><?php esc_html_e( 'Tisch reservieren','ambassador' ); ?></a>
    </div>
</div>
<section id="after-hero-gastronomie" class="after-hero-gastronomie bg-White md:pt-[3.75rem] md:pb-[6.25rem] xl:pt-[6.25rem] xl:pb-[9.38rem]">
    <div class="theme-container">
        <div class="theme-grid">
            ...
            <div class="col-start-1 col-span-2 md:col-start-1 md:col-span-4 xl:col-start-2 xl:col-span-4">
                <div class="title-main text-Brown md:pt-[1.88rem] xl:pt-0">
            ...
            <div class="col-start-1 col-span-2 md:col-start-1 md:col-span-4 xl:col-start-8 xl:col-span-4">
                <div class="body text-Brown md:pt-[1.88rem] xl:pt-0">

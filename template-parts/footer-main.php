				...
				<div class="flex md:block">
					...
					<span>
						<p class="footer-body break-words">
							<a href="tel:<?php echo get_field( 'general_phone', 'option' ); ?>" class="text-LightGray bg-Dark"><?php the_field( 'general_phone', 'option' ); ?></a>
						</p>
						<p class="footer-body break-all">
							...
							?>
							<a href="mailto:<?php echo $safe_email; ?>" class="text-LightGray bg-Dark"><?php echo $safe_email; ?></a>
						</p>

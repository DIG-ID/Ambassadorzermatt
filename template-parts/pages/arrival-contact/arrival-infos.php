          ...
          <!-- One row of the list -->
            ...
            <div class="grid grid-cols-8 md:grid-cols-5 xl:grid-cols-8 gap-5">
              ...
              <?php
                ...
                $link_target = $link['target'] ? $link['target'] : '_self';
              ?>
                <div class="col-span-1 btn btn-arrow">
        ...
        <?php while ( have_rows('arrival_info_repeater_2') ) : the_row(); ?>
          ...
          <!-- One row of the list -->
           <?php if ($link):
            ...
            $link_target = $link['target'] ? $link['target'] : '_self'; 
          ?>
          <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" class="btn-arrow-wrapper col-start-1 col-span-2 md:col-start-2 md:col-span-5 xl:col-start-5 xl:col-span-8 border-Dark border-b-[1px] last:border-b-0 last:pb-[7rem] xl:pt-[3.19rem] xl:pb-[6.25rem]">
          <?php else: ?>

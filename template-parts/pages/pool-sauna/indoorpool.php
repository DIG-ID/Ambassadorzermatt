<?php
/**
 * Indoor Pool Section in the Pool & Sauna Page Template.
 *
	...
	<div class="theme-container">
		<div class="theme-grid">
			...
			<div class="col-start-1 col-span-2 md:col-span-3 xl:hidden order-1">
				<?php
				if ( $img_left ) :
					echo wp_get_attachment_image( $img_left, 'full', false, array( 'class' => 'w-full max-h-auto' ) );
				endif;
				?>
				<!-- Tablet-only title (sits under left image) -->
				<h2 class="text-Dark title-main md:pt-[5rem] hidden md:block xl:hidden"><?php the_field( 'indoor_pool_title' ); ?></h2>
			</div>
			...
			<div class="col-start-1 col-span-2 md:col-start-4 md:col-span-3 xl:hidden order-2 pt-[2.56rem] md:pt-0">
				<?php
				if ( $img_right ) :
					echo wp_get_attachment_image( $img_right, 'full', false, array( 'class' => 'w-full max-h-auto' ) );
				endif;
				?>
			</div>
			...
			<div class="col-start-1 col-span-2 md:col-span-4 xl:hidden order-4 md:pt-[1.87rem]">
				<p class="text-Dark body"><?php the_field( 'indoor_pool_text' ); ?></p>
			</div>
			...
			<div class="hidden xl:block xl:col-start-2 xl:col-span-5 xl:order-2">
				...
				<div class="hidden xl:block xl:col-start-2 xl:col-span-5 xl:order-3 xl:pt-[3.75rem]">
					<?php
					if ( $img_left ) :
						echo wp_get_attachment_image( $img_left, 'full', false, array( 'class' => 'w-full h-auto object-cover' ) );
					endif;
					?>
				</div>
			</div>

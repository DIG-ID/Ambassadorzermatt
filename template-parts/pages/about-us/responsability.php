<section id="section-responsability" class="section-responsability bg-LightGray pt-[2.28rem] pb-[2.33rem] md:pt-[3.75rem] md:pb-[3.69rem] xl:pt-[5.44rem] xl:pb-[5.37rem]">
  <div class="theme-container">
    <div class="theme-grid">
      ...
      <!-- LEFT COLUMN: -->
        <div class="col-start-1 col-span-2 md:col-span-5 xl:col-start-1 xl:col-span-8">
            <?php
        ...
        <!-- Title -->
        <div class="pt-[2.48rem] md:pt-[3.79rem] xl:pt-[1.88rem]">
        ...
        <!-- Text  -->
        <div class="pt-[1.25rem] md:pt-[1.9rem] xl:pt-[1.88rem]">

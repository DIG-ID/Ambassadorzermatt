  ...
  <div class="theme-container">
    <div class="theme-grid">
      <div class="col-span-2 md:col-span-6 xl:col-span-12">
        <p class="title-secondary text-Dark"><?php the_field('hotel_overtitle'); ?></p>
        <h2 class="title-main text-Dark md:pt-5 xl:pt-4 md:mb-7 xl:mb-0"><?php the_field('hotel_title'); ?></h2>
      </div>

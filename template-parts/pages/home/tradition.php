...
?>
<section id="section-tradition" class="section-tradition bg-LightGray relative  md:min-h-[830] md:max-h-[830] xl:h-[785px] w-full z-20 flex flex-col justify-end md:justify-center">
	<?php

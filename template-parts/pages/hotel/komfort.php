<section id="Komfort" class="Komfort bg-LightGray pt-[2.19rem] md:pt-[5.81rem] md:pb-[5.75rem] xl:pt-[5.56rem] xl:pb-[5.63rem]">
    <div class="theme-container">
        <div class="theme-grid">
                ...
                <div class="xl:grid xl:grid-cols-6 xl:gap-x-5">
                    <div class="xl:col-span-5">
                        ...
                        <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" class="btn btn-primary mb-[2.44rem] md:mb-[3.75rem] xl:mb-0 mt-[2.5rem] md:mt-[3.75rem] xl:mt-[4.1875rem]">
                            ...
                            <?php endif;  ?>
                        <div class="pb-[2.25rem] xl:pt-[8.62rem] relative col-start-1 col-span-2 md:col-start-1 md:col-span-5 xl:col-start-1 xl:col-span-5 order-5 md:order-none">
                            <?php
            ...
            <div class="col-start-2 col-span-1 md:col-start-5 md:col-span-2 xl:col-start-8 xl:col-span-5 relative pb-[1.25rem] md:pb-0 order-4 md:order-none md:pt-[11.53rem] xl:pt-0">
            <?php

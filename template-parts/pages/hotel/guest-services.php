<?php
/**
 * Guest Services Section in the Hotel Page Template.
 *
...
?>
<section id="guest-services" class="guest-services bg-LightGray pt-[2.88rem] pb-[2.94rem] md:pt-[4.19rem] md:pb-[4.25rem] xl:pt-[5.38rem] xl:pb-[5.38rem]">
		...
		<div class="theme-grid">
			<div class="col-start-1 col-span-2 md:col-start-1 md:col-span-4 xl:col-start-1 xl:col-span-5 ">
				<div class="max-w-[14rem] md:max-w-none">
					<div class="flex items-baseline gap-[0.4em]"><span class="text-White">—</span><h2 class="title-secondary text-Dark "><?php the_field( 'guest-services_overtitle' ); ?></h2></div>
			...
			<div class="xl:col-span-6 pt-[1.22rem] md:pt-[1.86rem] xl:pt-[1.87rem]">
				<div class="xl:max-w-[33.56rem]">
					<p class="body text-Dark "><?php the_field( 'guest-services_text' ); ?></p>
				</div>
				<?php
				$olink = get_field( 'guest-services_button' );
				if ( $olink ) :
					$link_url    = $olink['url'];
			...
			<div class="md:hidden xl:block col-span-2 md:col-start-1 md:col-span-6 xl:col-start-7 xl:col-span-6 ">
				<?php
				$o_img = get_field( 'guest-services_image' );
				if ( $o_img ) :
			...
			<div class="hidden md:block xl:hidden col-span-2 md:col-start-1 md:col-span-6 xl:col-start-7 xl:col-span-6 ">
				<?php
				$o_img_t = get_field( 'guest-services_image_tablet' );
				if ( $o_img_t ) :

<?php
/**
 * Chefs Section in the Restaurant Carbon Page Template.
 *
	...
	<div class="theme-container">
		<div class="theme-grid pb-[6.2rem] xl:pb-[9.37rem]">
			...
			<div class="col-span-2 md:col-start-3 md:col-span-4 xl:col-start-7 xl:col-span-5 order-1 md:order-none">
				...
				<div class="title-main text-LightGray pt-[1.88rem] md:pt-[1.36rem] xl:pt-[1.87rem]">
					<h3><?php the_field('chefs_chef_name')?></h3>
				</div>
		...
		<div class="theme-grid pb-[6.2rem] xl:pb-[9.37rem] md:pt-0">
			<div class="col-span-2 md:col-span-4 xl:col-span-5">
				...
				<div class="title-main text-LightGray pt-[1.88rem] md:pt-[1.36rem] xl:pt-[1.87rem]">
					<h3><?php the_field('chefs_chef_name_2')?></h3>
				</div>
			...
			<div class="col-span-2 md:col-span-2 md:col-start-5 xl:col-start-7 xl:col-span-6 pt-[3.77rem] md:pt-0">
				<?php
					...
					false,
					[
					'class'    => 'w-full max-h-auto object-cover xl:max-h-[758px] bleed-right-full-md',
					'loading'  => 'eager',
					'decoding' => 'async',
					]
					);

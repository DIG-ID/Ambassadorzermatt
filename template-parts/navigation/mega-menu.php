<?php
/**
 * General Theme Navigation Template.
 *
...
<div id="menu-offcanvas" class="menu-offcanvas" aria-hidden="true" inert>
	...
	<!-- Mega menu content -->
	<nav id="mega-menu-nav" class="primary-nav theme-container theme-grid mb-6 md:mb-32 xl:mb-[74px] mt-7 md:mt-20 xl:mt-14 2xl:mt-16 overflow-visible" aria-label="<?php esc_attr_e( 'Main Menu', 'ambassador' ); ?>" role="navigation">
	...
	<!-- Mobile submenu screen -->
		<div class="submenu-mobile xl:hidden mt-[93px]" data-submenu-mobile aria-hidden="true" hidden>
			<div class="submenu-mobile__header border-b border-White flex items-center justify-between">
				
			 
			</div>

			<div class="submenu-mobile__body px-6 pb-8 pt-[2rem] md:min-h-[564px]" data-submenu-mobile-body>
				<?php
					ambassador_render_megamenu_panels( 'main-mega-menu' );
				?>
				<button class="back-arrow w-[35px] h-[33px] mt-8 submenu-mobile__back">
			...
			<div class="theme-container theme-grid pb-8 md:pb-0 bg-Brown">
				<div class="col-span-2 md:col-span-6 xl:col-span-12 flex flex-col md:flex-row justify-center items-center md:justify-between md:items-center py-6 md:pt-9 text-Brown gap-y-4">
					<div class="flex flex-col md:flex-row items-center justify-around w-full gap-y-4 md:gap-y-0">
	...
	<div class="theme-container theme-grid pb-8 md:pb-0">
		<div class="col-span-2 md:col-span-6 xl:col-span-12 flex flex-col md:flex-row justify-center items-center md:justify-between md:items-center py-6 md:pt-9 text-Brown gap-y-4">
			<div class="flex flex-col md:flex-row items-center justify-between w-full gap-y-4 md:gap-y-0">

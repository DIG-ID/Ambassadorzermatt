...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    ...
    if (document.body.classList.contains("single")) {
      _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox="room-gallery"]', {
        // optional config
        groupAll: true,
    ...
    if (document.body.classList.contains("page-template-page-experience-biking")) {
      _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox="biker-gallery"]', {
        Toolbar: {
          display: {
            left: [],
            middle: [],
      ...
      var zoomBtn = document.querySelector(".trails-zoom-trigger");
      if (zoomBtn) {
        zoomBtn.addEventListener("click", function (event) {
          event.preventDefault();
          var activeSlide = document.querySelector(".trailsSwiper .swiper-slide-active");
          var activeLink = activeSlide ? activeSlide.querySelector('[data-fancybox="biker-gallery"]') : null;
          if (activeLink) {
            activeLink.click();
          } else {
            console.warn("Nenhum [data-fancybox=\"biker-gallery\"] dentro do slide ativo");
          }
        });
      }
    }
...
/* harmony export */   ambassadorInitLenisCinematic: () => (/* binding */ ambassadorInitLenisCinematic)
/* harmony export */ });
...
var ambassadorEaseExpoOut = function ambassadorEaseExpoOut(t) {
 ...
 */
function ambassadorInitLenisCinematic() {
  var ambassadorLenis = new lenis__WEBPACK_IMPORTED_MODULE_2__["default"]({
    duration: 1.35,
  ...
  ambassadorLenis.on("scroll", gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.update);
...
// init
var ambassadorLenis = ambassadorInitLenisCinematic();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ambassadorzermattInitOffcanvasMenuGsap: () => (/* binding */ ambassadorzermattInitOffcanvasMenuGsap)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
...
(function () {
  ...
  var io = new IntersectionObserver(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
      entry = _ref2[0];
    return setActive(!entry.isIntersecting);
  }, {
    threshold: 0
  });
  io.observe(trigger);
...
function ambassadorzermattInitOffcanvasMenuGsap() {
  var btns = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(document.querySelectorAll(".menu-toggle__button"));
  var wrap = document.querySelector("#menu-offcanvas");
  ...
  if (!cols.length) cols = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(wrap.querySelectorAll('[class*="col-span-"]'));
  var targets = [document.body, document.documentElement];
  var prefersReduced = window.matchMedia("(prefers-reduced-motion: reduce)").matches;
  var polygonStart = "polygon(0 0, 100% 0, 100% 0, 0 0)"; // top edge only
  var polygonEnd = "polygon(0 0, 100% 0, 100% 100%, 0 100%)"; // full rect
  ...
  var setA11y = function setA11y(open) {
  ...
  var tl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    ...
    onReverseComplete: function onReverseComplete() {
      ...
      setA11y(false);
      btns.forEach(function (b) {
        return b.classList.remove("menu-open");
      });
    }
  });
  tl.addLabel("ambassadorzermattWrapStart", 0).to(wrap, {
    yPercent: 0,
    duration: 0.32,
    ease: "power4.inOut"
  }, "ambassadorzermattWrapStart").to(wrap, {
    clipPath: polygonEnd,
  ...
  }, "ambassadorzermattWrapStart+=0.40");
  var ambassadorzermattAllItems = cols.flatMap(function (col) {
    return Array.from(col.querySelectorAll("li"));
  });
  if (ambassadorzermattAllItems.length) {
    tl.fromTo(ambassadorzermattAllItems, {
      autoAlpha: 0,
      y: -8
    }, {
      autoAlpha: 1,
      ...
      ease: "power2.out",
      immediateRender: false
    }, "ambassadorzermattWrapStart+=0.30");
  }
  var openMenu = function openMenu() {
    btns.forEach(function (b) {
      return b.classList.add("menu-open");
    });
    setA11y(true);
    if (prefersReduced) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(wrap, {
  ...
  var closeMenu = function closeMenu() {
    if (!_toConsumableArray(btns).some(function (b) {
      return b.classList.contains("menu-open");
    })) return;
    btns.forEach(function (b) {
      return b.classList.remove("menu-open");
    });
  ...
  document.addEventListener("click", function (e) {
    var insideToggle = e.target.closest(".menu-toggle, .menu-toggle__button");
    var insideMenu = e.target.closest("#menu-offcanvas");
...
function ambassadorBindMegaPanels() {
  var root = document.querySelector('#menu-offcanvas');
  if (!root) return;
  var mainLinks = Array.from(root.querySelectorAll('.main-menu-col .mega-toplink'));
  var panels = Array.from(root.querySelectorAll('.sub-menu-col .submenu-panel'));
  var empty = root.querySelector('.sub-menu-col [data-empty]');
  var photos = Array.from(root.querySelectorAll('.mega-menu-photo')); // NEW
  var prefersReduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;

  // Map menu-item-id -> <img>
  var photosByMenuId = new Map();
  photos.forEach(function (img) {
    var mid = img.dataset.menuItemId;
    if (mid) photosByMenuId.set(String(mid), img);
  });

  // --- layout: lock a comfortable height (tallest panel) to prevent jumps ---
  var col = root.querySelector('.sub-menu-col');
  if (col) {
    var maxH = 0;
    panels.concat(empty || []).forEach(function (p) {
      var prevDisplay = p.style.display;
      var prevPos = p.style.position;
      var prevInset = p.style.inset;
  ...
  panels.forEach(function (p) {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(p, {
      autoAlpha: 0
    });
  ...
  if (empty) {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(empty, {
      autoAlpha: 0
    });
  ...
  var fadeInPhoto = function fadeInPhoto(img) {
    if (!img) return;
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(img);
  ...
  var fadeOutPhoto = function fadeOutPhoto(img) {
    if (!img) return;
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(img);
    if (prefersReduced) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(img, {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(img, {
        ...
        onComplete: function onComplete() {
          return img.classList.remove('is-visible');
        }
      });
    }
  ...
  if (photos.length) {
    photos.forEach(function (img, idx) {
      if (idx === 0) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(img, {
          autoAlpha: 1
        });
  ...
  // --- photo helpers (NEW) ---
  var showPhotoForMenuId = function showPhotoForMenuId(menuId) {
    if (!menuId || !photosByMenuId.size) return;
    var next = photosByMenuId.get(String(menuId));
    if (!next || next === activePhoto) return;
    if (activePhoto) fadeOutPhoto(activePhoto);
    fadeInPhoto(next);
    activePhoto = next;
  };
  var clearUnderline = function clearUnderline() {
  ...
  var activate = function activate(link) {
    ...
    var nextPanel = pid ? panels.find(function (p) {
      return p.dataset.parentId === String(pid);
    }) : null;

    // --- swap right-side photo based on link index ---  NEW
    var menuId = link.dataset.menuItemId;
    if (menuId) {
  ...
  var subLinks = Array.from(root.querySelectorAll('.sub-menu-col .submenu-panel a[data-menu-item-id]'));
...
(function () {
  var offcanvas = document.getElementById('menu-offcanvas');
  if (!offcanvas) return;
  var submenuMobile = offcanvas.querySelector('[data-submenu-mobile]');
  var submenuBody = offcanvas.querySelector('[data-submenu-mobile-body]');
  var backBtn = offcanvas.querySelector('.submenu-mobile__back');
  if (!submenuMobile || !submenuBody || !backBtn) return;
  var mqDesktop = window.matchMedia('(min-width: 1280px)');
  var topLinks = offcanvas.querySelectorAll('.menu-offcanvas__main-mega-menu .menu-item-has-children > a');
  var panels = submenuBody.querySelectorAll('.submenu-panel');
  var emptyState = submenuBody.querySelector('[data-empty]');
  function showMobileSubmenu(parentId, labelText) {
    // Hide all panels
    var anyVisible = false;
    panels.forEach(function (panel) {
      var match = panel.dataset.parentId === String(parentId);
  ...
  topLinks.forEach(function (link) {
    link.addEventListener('click', function (evt) {
      ...
      evt.preventDefault();
      var parentId = link.dataset.parentId;
      if (!parentId) return;
...
window.addEventListener("load", function () {
  if (document.querySelector(".single-zimmer-suiten")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.room-images-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      autoplay: {
  ...
  if (document.querySelector(".page-template-page-experience-skiing")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.ski-images-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      autoplay: {
  ...
  if (document.querySelector(".page-template-page-experience-biking")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.trails-images-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      autoplay: {
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.trailsSwiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      autoplay: {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkambassadorzermatt"] = self["webpackChunkambassadorzermatt"] || [];
